...
export const generateCambridgeBlueprint = httpsCallable(functions, 'generateCambridgeBlueprint');
export const generateBaselinePoolSpecs = httpsCallable(functions, 'generateBaselinePoolSpecs');
