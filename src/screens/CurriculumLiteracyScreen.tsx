...
const skills = ['Letter sounds', 'CVC blending', 'Sight words', 'Sentence order', 'Simple comprehension'];

export const CurriculumLiteracyScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
    <Text style={styles.title}>Curriculum · Literacy</Text>
    <Text style={styles.subtitle}>Stage-by-stage literacy progression and coverage health.</Text>

    <View style={styles.card}>
      <Text style={styles.cardTitle}>Coverage Summary</Text>
      <Text style={styles.cardText}>Blueprint mapping and pool readiness.</Text>
      <View style={styles.progressBar}>
        <View style={[styles.progressFill, { width: '72%' }]} />
      </View>
      <Text style={styles.progressLabel}>72% of skills have baseline pools</Text>
    </View>
